...
module.exports = async function(deployer, network, accounts) {
    ...
    if (network == "ropsten") {
        ...
        await deployer.deploy(InterestModel, "20000000000000000", "200000000000000000");
        await deployer.deploy(pETH, RiskManager.address, InterestModel.address, "1000000000000000000", "Pluto ETH", "pETH", 18, accounts[0])
        await deployer.deploy(pUSDT, tetherToken, RiskManager.address, InterestModel.address, "1000000", "Pluto USDT", "pUSDT", 18, accounts[0])
