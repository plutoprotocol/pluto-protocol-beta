...
module.exports = async function(deployer, network, accounts) {
    ...
    // 1 ETH = 50 pETH
    await deployer.deploy(pETH, RiskManager.address, InterestModel.address, 0.02e18.toString(), "Pluto ETH", "pETH", 18, accounts[0])
    // 1 USDT = 50 pUSDT
    await deployer.deploy(pUSDT, tetherToken, RiskManager.address, InterestModel.address, 0.02e6.toString(), "Pluto USDT", "pUSDT", 18, accounts[0])
